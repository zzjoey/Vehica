...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow",
                                      "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">Vehicle Brand Classification</span></p></body></html>"))
    ...
    def buttonAction1(self):
        ...
        file_path = QFileDialog.getOpenFileName(self, 'Choose Image', '', '(*.png);(*.jpg)')[0]
        # print(file_path)
    ...
    def buttonAction2(self):
        ...
        self.label_2.setText("Results: " + str(caption) + " \n" + "Time Cost: " + str(round(process_time, 3)) + ' s')
    ...
    def buttonAction3(self):
        QMessageBox.about(self, "About", "Vehicle-Classify\nAuthored by: github/Joey66666")
